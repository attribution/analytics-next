...
import { getNormalizedCategoriesFromGroupData, getNormalizedCategoriesFromGroupIds, getConsentedGroupIds, getOneTrustGlobal, } from '../lib/onetrust-api';
/**
 *
 ...
 */
export const withOneTrust = (analyticsInstance, settings = {}) => {
        ...
        registerOnConsentChanged: settings.disableConsentChangedEvent
            ...
            : (setCategories) => {
                getOneTrustGlobal().OnConsentChanged((event) => {
                    const normalizedCategories = getNormalizedCategoriesFromGroupIds(event.detail);
