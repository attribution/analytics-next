...
export const getPrunedCategories = async (getCategories, cdnSettings, integrationCategoryMappings) => {
    ...
    if (integrationCategoryMappings) {
        allCategories = uniq(Object.values(integrationCategoryMappings).reduce((p, n) => p.concat(n)));
    }
    else {
