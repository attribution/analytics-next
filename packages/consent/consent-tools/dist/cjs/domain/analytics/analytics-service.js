...
class AnalyticsService {
    get analytics() {
        return (0, exports.getInitializedAnalytics)(this._uninitializedAnalytics);
    }
    ...
    configureConsentStampingMiddleware({ getCategories, pruneUnmappedCategories, integrationCategoryMappings, }) {
        ...
        const getCategoriesForConsentStamping = async () => {
            if (pruneUnmappedCategories) {
                return (0, pruned_categories_1.getPrunedCategories)(getCategories, await this.cdnSettings, integrationCategoryMappings);
            }
            else {
